...
export const Navbar = () => {
  ...
  const navigationLinks = {
    ...
    admin: [
      ...
      { label: 'Resources', href: '/staff/resources' },
      { label: 'Allocations', href: '/staff/resources/allocations' },
      { label: 'Booking Approvals', href: '/admin/classroom-bookings' },
    ...
    staff: [
      ...
      { label: 'Quizzes', href: '/staff/quizzes' },
